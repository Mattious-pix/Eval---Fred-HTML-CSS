...
<div class="wrap">
	...
	<div class="gnrl1">
		<div class="chpprinc">
			...
			<h2 class="princis"> Des principautés nouvelles acquises par les armes et par l’habileté de <a href="https://gallica.bnf.fr/ark:/12148/btv1b531205218?rk=21459;2" target="_blank">l’acquéreur</a>.</h2>
			<blockquote class="textchp" cite="https://fr.wikisource.org/wiki/Le_Prince/Texte_entier" >
				...
				<footer>
					<a href="https://fr.wikisource.org/wiki/Le_Prince/Texte_entier" target="_blank"> Machiavel <cite>Le Prince (1532)</a>.</cite>
				</footer>
			</blockquote>
		</div>
			...
			<h2 class="caractech">Caractéristiques techniques !</h1>
				...
				<div class="Pzkwg">
					<h2><strong>Panzerkampfwagen</strong></h1>
						<p>
							Ca veut dire :
							<a href="https://fr.wikipedia.org/wiki/Char_de_combat" target="_blank"> TANK !! </a>
						</p>
					</div>
					...
					<div class="Pzrsch">
						<h2><strong> Panzerschreck !!!!!</strong>--><a href="https://www.youtube.com/watch?v=kIm7nOe_Sag" target="_blank" class="videoyt"> Clique !</a> </h2>
						<p>
							Weight : 5.1kg
						</p>
						<p>
