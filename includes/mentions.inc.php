<div class="mention">
	<h1 class="bordel">Mentions légales</h1>
	<img src="./assets/img/v1.gif" class="fusee" title="gifv1"/>
	<div class="cookies">
		...
		<p>
			...
			<div class="particuliers">
				...
				<p>
					- Nom, prénom, adresse et numéro de téléphone de l'hébergeur de son site internet.
				</p>
				<p>
					- Si le particulier ne souhaite pas garder l'anonymat, il doit indiquer les mentions légales le concernant et celles de l'hébergeur de son site internet.
				</p>
			</div>
			<div class="attention">
				<p>
